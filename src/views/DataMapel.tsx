      ...
      <div className="overflow-auto bg-white rounded-b-2xl border-t border-gray-200" style={{ maxHeight: 'calc(100vh - 280px)' }}>
        <table className="w-full text-left text-xs whitespace-nowrap">
          <thead className="bg-[#F8FAFC] text-slate-500 font-bold border-b border-gray-200 sticky top-0 z-10 shadow-sm">
            <tr>
              <th className="px-2 py-2 w-8 text-center text-[10px] uppercase tracking-wider" title="Geser urutan Mata Pelajaran">
              ...
              <th className="px-2 py-2 w-8 text-center text-[10px] uppercase tracking-wider">
                <input 
                  ...
                  title={isAllSelected ? "Batalkan pilihan semua" : "Pilih semua mata pelajaran"}
                />
              </th>
          ...
          <tbody className="divide-y divide-gray-100">
            ...
            {mapel.map((m, i) => (
              ...
              >
                {/* 1. Gagang Geser (Grip) */}
                <td 
                  className="px-2 py-2 text-center text-slate-300 group-hover:text-slate-500 cursor-grab active:cursor-grabbing select-none"
                  title="Klik dan geser untuk memindahkan urutan Mata Pelajaran ini"
                >
